      ...
      <div className="container">
        <div className="footer-top">
          <div className="footer-info">
            ...
            <a href="/playground" className="btn btn-primary btn-sm footer-cta">
              Try in Playground
            </a>
          </div>
          ...
          <div className="footer-links">
            ...
            <div className="link-group">
              ...
              <a href="https://github.com/santhosh-patel/substack-agent/discussions" target="_blank" rel="noopener noreferrer">Discussions</a>
